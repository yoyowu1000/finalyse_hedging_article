...
def main():
    ...
    print(f"Time Horizon: {max(l.time_years for l in liabilities)} years\n")
    ...
    if duration_result['success']:
        ...
        print(f"  Liability Duration: {duration_result['liability_duration']:.2f} years")
        print(f"  Portfolio PV: ${duration_result['portfolio_pv']:,.0f}")
        print(f"  Portfolio Duration: {duration_result['portfolio_duration']:.2f} years")
        print(f"  PV Matching Error: {abs(duration_result['portfolio_pv'] - duration_result['liability_pv'])/duration_result['liability_pv']*100:.2f}%")
        print(f"  Duration Matching Error: {abs(duration_result['portfolio_duration'] - duration_result['liability_duration']):.3f} years")
    ...
    if cashflow_result['success']:
        ...
        # Compare costs
        duration_cost = duration_result['portfolio_pv'] if duration_result['success'] else 0
    ...
    if duration_result['success']:
        ...
        print(f"  Interest Rate Sensitivity (±300 bps):")
